...
/PESQUISAR "adicione sua pesquisa".
A função de pesquisar  realiza uma busca no google.
Ex.: /pesquisar Era Vargas.

/CALCULAR "sua expressão matemática"
Resolve equações.
Ex.: /calcular 3+5*3
...
Ex.: /encurtar www.link.com

/HORARIO "cidade" 
Mostra a data e o horário na cidade correspondente.
Ex.: /horario Valença.
...
"/ALEATORIO número" 
Sorteia um número aleatório entre 0 e o número desejado.
Ex.: /aleatório 30.
        """
